  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.menu}>
        ...
        <LinkAsButton classNameGrid={styles.gameOneButton} text={"Игра 1. Переводчик"} to={ROUTES.GAME_TRANSLATION_PAGE}/>
        <LinkAsButton classNameGrid={styles.gameTwoButton} text={"Игра 2. Выбор"} to={"#"}/>
